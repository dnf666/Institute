...
oPaginate:{sFirst:"First",sLast:"Last",sNext:"next",sPrevious:"Previous"},sEmptyTable:"No data available in table",sInfo:"从 _START_ 到 _END_ 总共 _TOTAL_ 条记录",sInfoEmpty:"从 0 到 0  总共  0 条记录",sInfoFiltered:"(filtered from _MAX_ total entries)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"展示 _MENU_ 条记录",sLoadingRecords:"Loading...",sProcessing:"Processing...",sSearch:"Search:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"No matching records found"},oSearch:h.extend({},
